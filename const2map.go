...
func Usage() {
	...
	fmt.Fprintf(os.Stderr, "\tconst2enum [flags] -type T [directory]\n")
	fmt.Fprintf(os.Stderr, "\tconst2enum [flags] -type T files... # Must be a single package\n")
...
func main() {
	...
	g.Printf("// Code generated by \"const2enum %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
	...
	outputName := *output
	if outputName == "" {
		baseName := fmt.Sprintf("%s_c2e_gen.go", types[0])
